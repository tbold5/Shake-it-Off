  ...
  fetchData = () => {
    ...
    Promise.resolve([
      ...
      },
      {
        ...
        thumbnailUrl:
          'https://cdn.shopify.com/s/files/1/1061/1924/products/Sick_Emoji_PNG_large.png?v=1542436000',
      },
      {
        albumId: 1,
        id: 3,
        ...
        url: 'https://via.placeholder.com/600/771796',
        thumbnailUrl:
          'https://cdn.shopify.com/s/files/1/1061/1924/products/Super_Angry_Face_Emoji_ios10_large.png?v=1542436021',
      },
      {
        albumId: 1,
        id: 4,
      ...
      },
      {
        ...
        url: 'https://via.placeholder.com/600/771796',
        thumbnailUrl:
          'https://cdn.shopify.com/s/files/1/1061/1924/products/5_large.png?v=1544200554',
      },
    ])
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigate('secondListPage', {name: 'Jane'})}>
